          ...
          <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center">
            <div style="max-width: 25rem;">
              ...
              <ul class="list-unstyled mb-5">
                    <li>
                  <span class="d-block mb-1 fs-4 fw-light">Inscrivez vous si vous etes nouveaux sur la plateforme</span>
                       ...
                       <div class="col-12">
                            <div class="mb-2">
                                <label class="form-label">Mot de passe</label>
                                 <input id="password" name="password" class="form-control form-control-lg" type="password" placeholder="Entrez le mot de passe" required>
                              </div>
                       </div>

                        <div class="col-12 text-center mt-4">
                                <button type="submit" class="btn btn-lg btn-block btn-dark lift text-uppercase">Se connecter</button>
                        </div>

                    <div class="col-12 text-center mt-4">
                          <span class="text-muted">Vous n'avez pas encore de compte ? <a href="{{route('inscriptionVitrine')}}">Inscrivez-vous ici</a></span>
                    </div>
                   </form>
<!-- End Form -->
