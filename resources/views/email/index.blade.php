            ...
            <td class="container">
                <div class="content">
                    <div style="text-align: center;margin: 5px;">
                        <img src="{{ asset('photos/logo.png') }}" alt="Image Logo" style="width: 75px; height:75px">
                    </div>
                            ...
                            <tr>
                                <td class="content-block">
                                    <span class="apple-link">
                                        La plateforme de Centre Ivoirien AntiPolllution.
                                    </span>
                                </td>
                            </tr>
                            <tr>
                                <td class="content-block powered-by">
                                    <a href="#">CIAPOL</a> | Tel : (+225) 2722421619
                                    <br><br>
                                </td>
                            </tr>
                        </table>
