            ...
            <div class="col-12">
                <div class="access-card">
                    <div class="access-header text-center">
                        <h2><i class="fas fa-user-shield me-2"></i>Création d'un accès Administrateur</h2>
                    </div>
                    <div class="access-body">
                        <form method="POST" action="{{ route('adminAccesTrait') }}" id="accessForm">
                            @csrf
                            @method('POST')
                            <input type="text" name="administrateur_id"
                                value="{{ $administrateur->id}}" hidden>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nom"
                                        value="{{ old('nom', $administrateur->nom) }}" readonly disabled>
                                    <input type="text" class="form-control" name="nom"
                                        value="{{ old('nom', $administrateur->nom) }}" hidden>

                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="prenom" class="form-label required-field">Prenoms</label>
                                    <input type="text" class="form-control" id="prenom"
                                        value="{{ old('prenom', $administrateur->prenom) }}" readonly disabled>
                                    <input type="text" class="form-control" name="prenom"
                                        value="{{ old('prenom', $administrateur->prenom) }}" hidden>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="email" class="form-control" id="email"
                                        value="{{ old('email', $administrateur->email) }}" readonly disabled>

                                    <input type="email" class="form-control" name="email"
                                        value="{{ old('email', $administrateur->email) }}" hidden>

                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="phone" class="form-label">Téléphone</label>
                                    <input type="tel" class="form-control" id="phone"
                                        value="{{ old('phone', $administrateur->contact) }}"readonly disabled>
                                    <input type="tel" class="form-control" name="telephone"
                                        value="{{ old('phone', $administrateur->contact) }}" hidden>
                                    {{-- @error('phone')
