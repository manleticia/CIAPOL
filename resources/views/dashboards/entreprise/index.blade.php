                                        ...
                                        <td>
                                            {{-- @if ($entreprise->status == 2) --}}
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <a href="{{route('entreprises.taxes.index',$entreprise->id)  }}" class="btn btn-sm btn-outline-primary"
                                                        data-bs-toggle="tooltip" title="Taxe">
                                                        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)"
                                                                ...
                                                                <path d="M329 5106 c-58 -20 -97 -54 -129 -109 l-30 -52 0 -192 c0 -180 1
                                                                ...
                                                                61 -29z" />
                                                                                                                            <path d="M4263 2213 c-23 -9 -533 -869 -533 -898 0 -28 40 -75 64 -75 46 0 68
                                                                ...
                                                                l0 -90 -87 -3 -88 -3 0 96 0 96 88 -3 87 -3 0 -90z" />
                                                                                                                            <path d="M572 2280 c-61 -38 -72 -69 -72 -216 0 -119 2 -134 23 -164 12 -18
