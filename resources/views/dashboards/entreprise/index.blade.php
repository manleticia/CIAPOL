                    ...
                    <div class="row mb-3 justify-content-center">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <button class="btn btn-outline-secondary text-danger" type="button" id="clearSearch" >Effacer</button>
                            </div>
                        </div>
                    </div>
        ...
        $(document).ready(function() {
            var table = $('#entreprisesTable').DataTable({
                ...
                columnDefs: [{
                    ...
                    targets: [
                        6
                    ] // Désactiver le tri sur la colonne Actions (index 6 car on commence à 0)
                }]
            });
            ...
            $('#raisonSocialeSearch').keyup(function() {
                table.column(1) // Colonne Raison Sociale (index 1)
                    .search($(this).val())
                    .draw();
            });
