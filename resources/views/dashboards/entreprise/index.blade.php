@extends('layouts.dashboard', ['title' => 'Entreprise  - TABLEAU DE BORD'])
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="card-title m-0">Liste des entreprises</h6>
                    <div>
                                                ...
                                                <a href="{{ route('entreprises.taxes.index', $entreprise->id) }}"
                                                    ...
                                                    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="20"
                                                        ...
                                                        <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)"
                                                            ...
                                                            <path
                                                                d="M4285 1701 c-89 -40 -139 -119 -140 -221 0 -53 5 -73 28 -112 84
                                                                                                            ...
                                                                                                            41 92 44 129 6z" />
                                                            <path
                                                                d="M605 4765 c-14 -13 -25 -36 -25 -50 0 -14 11 -37 25 -50 21 -22 33
                                                            ...
                                                            <path
                                                                d="M1569 4775 c-15 -8 -33 -31 -41 -52 -110 -278 -248 -655 -248 -676 0
                                                            ...
                                                            <path d="M2166 4769 c-47 -37 -37 -69 65 -214 50 -72 93 -135 96 -142 3 -7
                                                                                                            ...
                                                                                                            -175 112z" />
                                                            <path
                                                                d="M585 3610 c-72 -37 -80 -56 -83 -215 -3 -133 -2 -142 20 -175 50 -75
                                                            ...
                                                            <path
                                                                d="M2901 3608 c-70 -37 -81 -69 -81 -223 0 -146 11 -177 72 -215 29 -17
                                                            ...
                                                            <path
                                                                d="M615 2963 c-31 -8 -83 -51 -100 -83 -11 -21 -15 -63 -15 -158 0 -117
                                                                                                            ...
                                                                                                            915 0 915 0 0 -95z" />
                                                            <path
                                                                d="M2926 2960 c-16 -5 -40 -19 -53 -32 -47 -43 -53 -68 -53 -206 0 -117
                                                            ...
                                                            <path
                                                                d="M582 1623 c-19 -9 -44 -32 -58 -52 -22 -33 -24 -44 -24 -166 0 -151
...
@push('js')
    ...
    <script>
        $(document).ready(function() {
            var table = $('#entreprisesTable').DataTable({
                language: {
                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        customize: function(doc) {
                            ...
                            // Ajouter une date en bas de page
                            var now = new Date();
                            var jsDate = now.getDate() + '/' + (now.getMonth() + 1) + '/' + now
                                .getFullYear();
                            doc.footer = {
                                text: 'Exporté le ' + jsDate,
                                margin: [20, 0, 20, 0],
                                fontSize: 8,
                                alignment: 'right'
                            };
                ...
                columnDefs: [{
                    orderable: false,
                    targets: [6] // Désactiver le tri sur la colonne Actions
                }]
            });
            ...
            // Filtrer le tableau par raison sociale
            $('#raisonSocialeSearch').keyup(function() {
                table.column(1).search($(this).val()).draw();
            });

            // Effacer la recherche
            $('#clearSearch').click(function() {
                $('#raisonSocialeSearch').val('');
