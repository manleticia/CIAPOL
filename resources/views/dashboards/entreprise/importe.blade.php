@extends('layouts.dashboard', ['title' => 'Entreprise Importe  - TABLEAU DE BORD'])
@section('content')
                    ...
                    <div class="main-container">
                        ...
                        <div class="upload-container">
                            <div class="upload-header">
                                ...
                                <p>Formats acceptés: .xls, .xlsx (Max. 5MB)</p>
                            </div>
                            ...
                            <form method="POST" action="{{ route('entreprises.traitementImportationExcel') }}" enctype="multipart/form-data" id="uploadForm">
                                {{-- {{ route('upload.excel') }} --}}
                                @csrf
                                <div class="upload-area" id="uploadArea">
                                    ...
                                    <p>ou</p>
                                    <button type="button" class="browse-btn" id="browseBtn">Parcourir les
                                        fichiers</button>
                                ...
                                <div class="file-info" id="fileInfo">
                                    <p>
                                        ...
                                        <span class="remove-file" id="removeFile"><i class="fas fa-times"></i></span>
                                    </p>
                                </div>

                                <button type="submit" class="submit-btn" id="submitBtn" disabled>Importer le
                                    fichier</button>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="tab-pane fade show active" id="step1">
                                            ...
                                            <span class="card">
                                                <span class="card-body d-flex p-3">
                                                    ...
                                                    <span class="ms-3">
                                                        ...
                                                        <span class="text-muted">For smaller business, with
                                                            simple salaries and pay schedules.</span>
                                                    </span>
                                                </span>
                                            </span>
                                        </label>
                                            ...
                                            <span class="card">
                                                <span class="card-body d-flex p-3">
                                                    ...
                                                    <span class="ms-3">
                                                        ...
                                                        <span class="text-muted">For growing business who wants
                                                            to create a rewarding place to work.</span>
                                                    </span>
                                                </span>
                                            </span>
                                        </label>
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted small">It is a long established fact that a reader
                                        will be distracted by Luno.</p>
                        ...
                        <div class="tab-pane fade active show" id="Notetab-all" role="tabpanel">
                            ...
                            <div class="card ribbon mb-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <span>Many desktop publishing packages and web page editors now use Lorem
                                        Ipsum as their default model</span>
                                </div>
                                <div class="card-footer pt-0 border-0">
                                    <a class="btn btn-sm btn-outline-secondary" href="#"><i
                                            class="fa fa-star favourite-note"></i></a>
                ...
                <div class="d-flex align-items-start">
                    <div class="nav flex-column nav-pills p-3 h-100">
                        ...
                        <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
                            ...
                            <img class="avatar sm rounded-circle border" src="{{ asset('assets/img/xs/avatar3.jpg') }}"
                                alt="avatar">
                        </a>
                        <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
                            data-bs-target="#c-user-2" title="">
                            <img class="avatar sm rounded-circle border" src="{{ asset('assets/img/xs/avatar4.jpg') }}"
                                alt="avatar">
                        </a>
                        <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
                            data-bs-target="#c-user-5" title="">
                            <img class="avatar sm rounded-circle border" src="{{ asset('assets/img/xs/avatar5.jpg') }}"
                                alt="avatar">
                        </a>
                        <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
                            data-bs-target="#c-user-1" title="">
                            <img class="avatar sm rounded-circle border" src="{{ asset('assets/img/xs/avatar6.jpg') }}"
                                alt="avatar">
                        </a>
                        <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
                            data-bs-target="#c-user-7" title="">
                            <img class="avatar sm rounded-circle border" src="{{ asset('assets/img/xs/avatar7.jpg') }}"
                                alt="avatar">
                        </a>
                        <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
                            data-bs-target="#c-user-3" title="">
                            <img class="avatar sm rounded-circle border" src="{{ asset('assets/img/xs/avatar8.jpg') }}"
                                alt="avatar">
                        </a>
                        <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
                            data-bs-target="#c-user-3" title="">
                            <img class="avatar sm rounded-circle border" src="{{ asset('assets/img/xs/avatar9.jpg') }}"
                                alt="avatar">
                        </a>
                        <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
                            data-bs-target="#c-user-1" title="">
                            <img class="avatar sm rounded-circle border" src="{{ asset('assets/img/xs/avatar10.jpg') }}"
                                alt="avatar">
                        </a>
                        <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
                            data-bs-target="#c-user-1" title="">
                                                ...
                                                <div class="card p-3">
                                                    <div class="message">
                                                        ...
                                                        <img class="w120 img-thumbnail"
                                                            src="{{ asset('assets/img/gallery/3.jpg') }}" alt="">
                                                        <img class="w120 img-thumbnail"
                                                            src="{{ asset('assets/img/gallery/4.jpg') }}" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- More option -->
