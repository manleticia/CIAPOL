        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="card-title m-0">Détails du chèque</h6>
                    <span
                        ...
                        <div class="col-md-6">
                            <div class="card mb-4">
                                <div class="card-header bg-light">
                                    <h5 class="mb-0 text-uppercase">Informations du {{  $cheque->NaturePaiement ?? "xxxxxxx" }}</h5>
                                </div>
                                <div class="card-body">
                                    ...
                                    @endif
                                    <div class="mb-3">
                                        <h6>Numéro de <span class="text-lowercase">{{  $cheque->NaturePaiement ?? "xxxxxxx" }}</span></h6>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    <p>Êtes-vous sûr de vouloir valider ce chèque ?</p>
                    <p class="fw-bold">Numero du cheque : {{ ($cheque->numero_cheque ?? "xxxxxxxxx" ) }} </p>
                    <p class="fw-bold">Montant: {{ number_format($cheque->montant, 0, ',', ' ') }} FCFA</p>
                </div>
