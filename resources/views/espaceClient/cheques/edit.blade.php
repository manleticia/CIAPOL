...
<body>
            ...
            <div class="payment-body">
                ...
                <div class="payment-steps">
                    ...
                    <div class="step">
                        ...
                        <div class="step-content">
                            <strong id="testEnvoyer">Envoi du chèque</strong>
                            <p id="params1">Envoyez votre chèque accompagné du bordereau à notre service financier à
                                l'adresse :</p>
                    ...
                    <div class="step">
                        ...
                        <div class="step-content">
                            ...
                            <p id="params2">Votre compte sera crédité sous 48h ouvrées après réception et
                                encaissement du chèque.</p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const test2 = document.getElementById('testEnvoyer');
            ...
            natureSelect.addEventListener('change', function() {
                if (this.value === 'CHEQUE') {
                    ...
                    test2.textContent = 'Envoi du chèque';
                    params1.textContent =
                        "Envoyez votre chèque accompagné du bordereau à notre service financier à l'adresse :";
                    params2.textContent =
                        "Votre compte sera crédité sous 48h ouvrées après réception et encaissement du chèque.";
                    ...
                    test2.textContent = 'Envoi du virement';
                    params1.textContent =
                        "Envoyez votre virement accompagné du bordereau à notre service financier à l'adresse :";
                    params2.textContent =
                        "Votre compte sera crédité sous 48h ouvrées après réception et encaissement du virement.";
