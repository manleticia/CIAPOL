                                         ...
                                         <div class="tab-pane fade show active" id="Noti-tab-Message"
                                             ...
                                             <ul class="list-unstyled list mb-0">
                                                 <li class="py-2 mb-1 border-bottom">
                                                     <a href="javascript:void(0);" class="d-flex">
                                                         <img class="avatar rounded-circle"
                                                             src="{{ asset('assets/img/xs/avatar5.jpg') }}"
                                                             alt="">
                                                 ...
                                                 <li class="py-2 mb-1 border-bottom">
                                                     <a href="javascript:void(0);" class="d-flex">
                                                         <img class="avatar rounded-circle"
                                                             src="{{ asset('assets/img/xs/avatar6.jpg') }}"
                                                             alt="">
                                                         <div class="flex-fill ms-3">
                                                             <p class="d-flex justify-content-between mb-0">
                                                 ...
                                                 <li class="py-2 mb-1 border-bottom">
                                                     <a href="javascript:void(0);" class="d-flex">
                                                         <img class="avatar rounded-circle"
                                                             src="{{ asset('assets/img/xs/avatar3.jpg') }}"
                                                             alt="">
                                                         <div class="flex-fill ms-3">
                                                             <p class="d-flex justify-content-between mb-0">
                                                 ...
                                                 <li class="py-2 mb-1 border-bottom">
                                                     <a href="javascript:void(0);" class="d-flex">
                                                         <img class="avatar rounded-circle"
                                                             src="{{ asset('assets/img/xs/avatar4.jpg') }}"
                                                             alt="">
                                                         <div class="flex-fill ms-3">
                                                             <p class="d-flex justify-content-between mb-0">
                                                 ...
                                                 <li class="py-2">
                                                     <a href="javascript:void(0);" class="d-flex">
                                                         <img class="avatar rounded-circle"
                                                             src="{{ asset('assets/img/xs/avatar7.jpg') }}"
                                                             alt="">
                                                         <div class="flex-fill ms-3">
                                                             <p class="d-flex justify-content-between mb-0">
                                ...
                                <div class="card-body border-bottom d-flex">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <h6 class="card-title mb-0">
                                            {{ auth()->user()->administrateur->nom ?? 'xxxxxx' }} {{ auth()->user()->administrateur->prenom ?? 'xxxxxx' }}
                                        </h6>
                                        <span
        ...
        <div class="row align-items-center">
            ...
            {{-- <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-7 col-sm-12 mt-2 mt-md-0">
                <div class="input-group">
                    ...
                    <button class="btn btn-outline-secondary" type="button" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="Download Reports"><i class="fa fa-download"></i></button>
                    <button class="btn btn-outline-secondary" type="button" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="Generate PDF"><i class="fa fa-file-pdf-o"></i></button>
                    <button class="btn btn-outline-secondary" type="button" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="Share Dashboard"><i class="fa fa-share-alt"></i></button>
                </div>
            </div> --}}
        </div> <!-- .row end -->
    </div>
